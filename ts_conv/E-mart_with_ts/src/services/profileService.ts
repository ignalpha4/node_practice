...
//obj of profile token
const profileTokenObj = new profileTokenClass();

export class profileServiceClass{
    
    addProfileService = async(userId:ObjectId,profileName:String,res:Response) : Promise<IProfileModel > =>{
    ...
    listProfilesService =async(userId:ObjectId) : Promise<any> =>{
    ...
    deleteProfileService =async(profileId:ObjectId,userId:ObjectId,res:Response):Promise<any>=>{
    ...
    selectProfileService = async(profileId:ObjectId,userId:ObjectId,res:Response):Promise<String>=>{
        ...
        const token = profileTokenObj.createProfileToken(foundProfile._id,foundUser.email);
